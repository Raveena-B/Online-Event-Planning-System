...
<!-- to validate the fields in the form before the form is submitted -->
...
<div class="new">
    ...
    <div style="text-align: center">
        <h1>Event Planner Login</h1><br>
        <center><h4 class="h2">Username and Password is  incorrect . please Enter valid username and password</h4></center><br>
